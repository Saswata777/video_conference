        ...
        <section className="bg-gray-900">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              <div className=" mr-auto place-self-center lg:col-span-7">
                ...
                <a href="#/" className="inline-flex items-center justify-center border-4 px-5 py-3 text-base font-medium text-center text-gray-900  border-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-900 focus:ring-4 focus:ring-gray-100 text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                  Speak to Sales
                </a>
                </div>
